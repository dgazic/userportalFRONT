...
class listOfAllTicketsScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _listOfAllTicketsScreenState();
  }
}

class _listOfAllTicketsScreenState extends State<listOfAllTicketsScreen> {
  ...
  void initState() {
    ...
    ticketProvider.GetHospitalUsers(userHospital).then((value) {
      dropdownHospitalUsersSource.addAll(value);
    });
  }
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: 20),
                                        child: Container(
                                            child: _buildHospitalUsersField(
                                                _setter))),
                                  ],
                                )
                              : Container(),
